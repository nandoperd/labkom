                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo form_open('labkom/update/' . $d['id']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input name="kepala_lab" class="form-control" value="<?= $d['kepala_lab'] ?>" required>
                            </div>

                            <div class="form-footer">
                                <button type="submit" class="btn btn-success">Update</button>
                                <a href="<?= base_url('labkom') ?>" class="btn btn-danger">Kembali</a>
                            </div>
